...
class aquaterias_Theme_Includes {
	...
	public static function init() {
		 ...
		 */
		{
			...
			add_action( 'init', array( __CLASS__, 'aquaterias_action_init' ) );
		}
		 ...
		 */
		if ( ! is_admin() ) {
			add_action('wp_enqueue_scripts', array( __CLASS__, 'aquaterias_action_enqueue_scripts' ),
	...
	private static function get_includes_files_list($dir_rel_path){
		...
		$custom_list =  apply_filters ('aquaterias_filter_init_includes_custom_files', array());
	 ...
	 * @internal
	 */
	public static function aquaterias_action_enqueue_scripts() {
	 ...
	 * @internal
	 */
	public static function aquaterias_action_init() {
		self::include_child_first( '/menus.php' );
		self::include_child_first( '/posts.php' );
	}
}

aquaterias_Theme_Includes::init();
