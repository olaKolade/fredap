 ...
 */
if ( !function_exists('aquaterias_generate_css') ) {

	function aquaterias_generate_css() {
		...
		$css['black_dark_color'] = aquaterias_color_change($css['black_color'], -0.15);
		$css['black_darker_color'] = aquaterias_color_change($css['black_color'], -0.35);
