...
// Color
$theme_style .= "
.widget .search-form a, .page-content .search-form a,
a,
a.black:hover,
a.black:focus,
footer a,
...
nav.navbar #navbar ul.navbar-nav ul.children li a::after, nav.navbar #navbar ul.navbar-nav ul.sub-menu li a::after,
.top-search,
...
.bg-color-gradient {
	...
	background: linear-gradient(to right, rgba({$css_rgb['black_color'][0]}, {$css_rgb['black_color'][1]}, {$css_rgb['black_color'][2]}, 1) 0%, rgba({$css_rgb['main_color'][0]}, {$css_rgb['main_color'][1]}, {$css_rgb['main_color'][2]}, 1) 100%) !important;
}


.woocommerce #payment #place_order, .woocommerce-page #payment #place_order, .woocommerce-cart .wc-proceed-to-checkout a.checkout-button, .woocommerce div.product form.cart .button, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .button, input[type=\"submit\"], .wpcf7-submit, .btn, .woocommerce-product-search input[type=\"submit\"], .wp-searchform input[type=\"submit\"], form.post-password-form input[type=\"submit\"], form.search-form input[type=\"submit\"], form.wpcf7-form input[type=\"submit\"], form.form input[type=\"submit\"], form.comment-form input[type=\"submit\"], form input[type=\"submit\"] {

	-webkit-box-shadow: 0 10px 30px rgba({$css_rgb['main_color'][0]}, {$css_rgb['main_color'][1]}, {$css_rgb['main_color'][2]}, 0.3);
	-moz-box-shadow: 0 10px 30px rgba({$css_rgb['main_color'][0]}, {$css_rgb['main_color'][1]}, {$css_rgb['main_color'][2]}, 0.3);
	box-shadow: 0 10px 30px rgba({$css_rgb['main_color'][0]}, {$css_rgb['main_color'][1]}, {$css_rgb['main_color'][2]}, 0.3);	
}

.wpb_single_image .vc_single_image-wrapper.vc_box_shadow img {

	-webkit-box-shadow: 20px 20px 0 {$css['main_color']} !important;
	-moz-box-shadow: 20px 20px 0 {$css['main_color']} !important;
	box-shadow: 20px 20px 0 {$css['main_color']} !important;	
}
