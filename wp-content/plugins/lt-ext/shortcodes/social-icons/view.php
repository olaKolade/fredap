	...
	foreach ( $atts['icons'] as $item ) {
		...
		if ( $atts['type'] == 'icons-list' ) {
			...
			if ( empty( $item['href'] ) ) {
				...
				echo '<li class="'. esc_attr($li_class) .'"><span class="'. esc_attr( $item['icon_fontawesome'] ) .'"></span><span class="head">'. esc_html( $item['header'] ) .'</span></li>';
			}
				else {

				echo '<li class="'. esc_attr($li_class) .'"><a href="'. esc_url( $item['href'] ) .'"><span class="'. esc_attr( $item['icon_fontawesome'] ) .'"></span><span class="head">'. esc_html( $item['header'] ) .'</span></a></li>';
			}
		}
			else {
